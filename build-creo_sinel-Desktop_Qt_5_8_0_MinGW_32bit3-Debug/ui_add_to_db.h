...
public:
    ...
    {
        add_to_db->setWindowTitle(QApplication::translate("add_to_db", "Add project to database", Q_NULLPTR));
        lblProjnb->setText(QApplication::translate("add_to_db", "Project Number:", Q_NULLPTR));
        lblProjName->setText(QApplication::translate("add_to_db", "Project Name:", Q_NULLPTR));
        lblMainDir->setText(QApplication::translate("add_to_db", "Main Directory:", Q_NULLPTR));
        lblLocalDirs->setText(QApplication::translate("add_to_db", "Local Directory:", Q_NULLPTR));
    } // retranslateUi
