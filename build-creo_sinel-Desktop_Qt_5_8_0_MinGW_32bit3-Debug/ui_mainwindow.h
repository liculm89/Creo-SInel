...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        projectsList->setGeometry(QRect(50, 270, 71, 192));
        groupBox = new QGroupBox(centralWidget);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(10, 20, 151, 241));
        databaseTables = new QListWidget(groupBox);
        databaseTables->setObjectName(QStringLiteral("databaseTables"));
        databaseTables->setGeometry(QRect(20, 50, 101, 151));
        ...
        tableWidget->setGeometry(QRect(180, 30, 881, 371));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(50, 470, 75, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        ___qtablewidgetitem1->setText(QApplication::translate("MainWindow", "Project name", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("MainWindow", "Main directory", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("MainWindow", "Local directory", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("MainWindow", "Assemblys", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("MainWindow", "Parts", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidget->horizontalHeaderItem(6);
        ___qtablewidgetitem6->setText(QApplication::translate("MainWindow", "Drawings", Q_NULLPTR));
        pushButton->setText(QApplication::translate("MainWindow", "Details...", Q_NULLPTR));
